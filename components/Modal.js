				...
				? `<div class="modal-container">
						...
						<div class="modal-header">
							...
							<div class="modal-card-title">
								...
								<div class="modal-card-list-item-title">В списку <span href="#">${
							...
							<div class="modal-card-content">
								<div class="modal-card-content-header">
									<div class="content-title-wrapper">
										<div class="content-title">Опис таски</div>
										<span class="caution">Зберегти зміни 👉</span>
									</div>
									${
								...
								<textarea class="modal-card-content-textarea" placeholder="Подробиці">${
